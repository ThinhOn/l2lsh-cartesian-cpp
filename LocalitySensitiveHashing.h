...
typedef struct _RNNParametersT {
  float parameterR; // parameter R of the algorithm.
  float successProbability; // the success probability 1-\delta
  IntT dimension; // dimension of points.
  float parameterR2; // = parameterR^2
  ...
  float parameterW; // parameter W of the algorithm.
